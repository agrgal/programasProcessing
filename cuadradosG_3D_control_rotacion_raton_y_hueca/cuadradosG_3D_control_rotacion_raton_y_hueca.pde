...
void setup() {
 ...
 for (int escalon=maxNivel; escalon>=0; escalon--) { // pirámide escalonada
   ...
   // para que sea hueca, simplemente permito un solo nivel por escalon, el superior
   for (int nivel=escalon;nivel<=escalon;nivel++) { // pongo desde nivel 0 y así tb dibujo el del medio.
